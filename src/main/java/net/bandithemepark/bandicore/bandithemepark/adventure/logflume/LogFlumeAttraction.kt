...
class LogFlumeAttraction: Attraction("logflume", AttractionAppearance("Logflume", listOf("Join Bandiana Jones on his adventure", "and uncover the secrets of a newly", "discovered temple. Be prepared for", "things to get out of hand!"), Material.DIAMOND_HOE, 1)) {
