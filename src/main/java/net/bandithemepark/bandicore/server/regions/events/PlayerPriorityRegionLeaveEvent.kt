...
class PlayerPriorityRegionLeaveEvent(var player: Player, var fromRegion: BandiRegion, var toRegion: BandiRegion?, var fromLocation: Location, var toLocation: Location):
    Event(), Cancellable {
