        ...
        client.newCall(request).enqueue(object: Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if(responseJson.has("data") && !responseJson.get("data").isJsonNull) {
                    ...
                    BandiCore.instance.logger.severe("An attempt was made at retrieving data of setting $name, but no data was found. The following message was given: ${responseJson.get("message")}")
                }
            }
        })
    }
