...
import net.bandithemepark.bandicore.park.cosmetics.types.Backpack.Companion.getBackpack
...
class BackpackCosmetic: CosmeticType("backpack") {
    ...
    override fun onEquip(player: Player, color: Color?, cosmetic: Cosmetic) {
        ...
        //player.getBackpack()?.model = itemStack
    }

    override fun onUnEquip(player: Player) {
        player.getBackpack()?.model = null
    }
